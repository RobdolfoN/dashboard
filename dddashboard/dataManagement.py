...
######################## QUERY_SET TEST #########################################
# cached_queryset1 = cache.get('queryset1')
# if not cached_queryset1:

#     queryset1 = CompanyData.objects.all().select_related('name')
#     cache.set('queryset1', queryset1, 3600)
#     cached_queryset1 = cache.get('queryset1')

# queryset2 = CompanyData.objects.filter(name=company)
...
def q_size_create_donut_chart(field_name, size, cached_queryset1):
    # Get the count of 'Y' and 'N' values for the field
    most_recent_date = datetime.now().year
    data = cached_queryset1.filter(company_size=size, year_created=most_recent_date).values(field_name).annotate(count=Count(field_name))
    yes_count = next((item for item in data if item[field_name] == 'Y'), {'count': 0})['count']
    no_count = next((item for item in data if item[field_name] == 'N'), {'count': 0})['count']
    total = yes_count + no_count
...
def q_size_sex_donut_industrychart(size, cached_queryset1):
    most_recent_date = datetime.now().year
    male = cached_queryset1.filter(gender_code='M', company_size=size, year_created=most_recent_date).count()
    female = cached_queryset1.filter(gender_code='F', company_size=size, year_created=most_recent_date).count()
    other = cached_queryset1.filter(gender_code='O', company_size=size, year_created=most_recent_date).count()
    total = cached_queryset1.filter(company_size=size, year_created=most_recent_date).count()
...
# def contextCreator(dashboardusercompany, companyname):

#     queryset1 = CompanyData.objects.all()
#     cache.set('queryset1', queryset1, 3600)
#     cached_queryset1 = cache.get('queryset1')

#     queryset2 = CompanyData.objects.filter(name_id=dashboardusercompany)
#     cache.set('queryset2', queryset1, 3600)
#     cached_queryset2 = cache.get('queryset2')




#     def q_Companydata_sex_donut_industrychart():
#         most_recent_date = datetime.now().year
#         male = cached_queryset2.filter(gender_code='M', year_created=most_recent_date).count()
#         female = cached_queryset2.filter(gender_code='F', year_created=most_recent_date).count()
#         other = cached_queryset2.filter(gender_code='O', year_created=most_recent_date).count()
...
#     def q_Companydata_create_donut_chart(field_name):
#         # Get the count of 'Y' and 'N' values for the field
#         most_recent_date = datetime.now().year
#         data = cached_queryset2.filter(year_created=most_recent_date).values(field_name).annotate(count=Count(field_name))
#         yes_count = next((item for item in data if item[field_name] == 'Y'), {'count': 0})['count']
...
#     def q_sex_barchart_industrychart(position, cheight):
#         most_recent_date = datetime.now().year
#         gender_codes = ['M', 'F', 'O']
#         data = cached_queryset1.filter(Q(gender_code__in=gender_codes) & Q(position_category=position) & Q(year_created=most_recent_date)).values('gender_code').annotate(count=Count('gender_code'))
...
#     def q_c_sex_barchart_industrychart(position, cheight):
#         most_recent_date = datetime.now().year
#         gender_codes = ['M', 'F', 'O']
#         data = cached_queryset2.filter(Q(gender_code__in=gender_codes) & Q(position_category=position) & Q(year_created=most_recent_date)).values('gender_code').annotate(count=Count('gender_code'))
...
#     def q_minority_barchart_industrychart(position, cheight):
#         most_recent_date = datetime.now().year
#         visible_minorities = ['Y', 'N']
#         data = cached_queryset1.filter(Q(visible_minorities__in=visible_minorities) & Q(position_category=position) & Q(year_created=most_recent_date)).values('visible_minorities').annotate(count=Count('visible_minorities'))
...
#     def q_c_minority_barchart_industrychart(position, cheight):
#         most_recent_date = datetime.now().year
#         visible_minorities = ['Y', 'N']
#         data = cached_queryset2.filter(Q(visible_minorities__in=visible_minorities) & Q(position_category=position) & Q(year_created=most_recent_date)).values('visible_minorities').annotate(count=Count('visible_minorities'))
...
#     def q_aboriginal_barchart_industrychart(position, cheight):
#         most_recent_date = datetime.now().year
#         aboriginal_peoples = ['Y', 'N']
#         data = cached_queryset1.filter(Q(visible_minorities__in=aboriginal_peoples) & Q(position_category=position) & Q(year_created=most_recent_date)).values('aboriginal_peoples').annotate(count=Count('aboriginal_peoples'))
...
#     def q_c_aboriginal_barchart_industrychart(position, cheight):
#         most_recent_date = datetime.now().year
#         aboriginal_peoples = ['Y', 'N']
#         data = cached_queryset2.filter(Q(visible_minorities__in=aboriginal_peoples) & Q(position_category=position) & Q(year_created=most_recent_date)).values('aboriginal_peoples').annotate(count=Count('aboriginal_peoples'))
...
#     def q_disability_barchart_industrychart(position, cheight):
#         most_recent_date = datetime.now().year
#         person_with_disabilities = ['Y', 'N']
#         data = cached_queryset1.filter(Q(visible_minorities__in=person_with_disabilities) & Q(position_category=position) & Q(year_created=most_recent_date)).values('person_with_disabilities').annotate(count=Count('person_with_disabilities'))
...
#     def q_c_disability_barchart_industrychart(position, cheight):
#         most_recent_date = datetime.now().year
#         person_with_disabilities = ['Y', 'N']
#         data = cached_queryset2.filter(Q(visible_minorities__in=person_with_disabilities) & Q(position_category=position) & Q(year_created=most_recent_date)).values('person_with_disabilities').annotate(count=Count('person_with_disabilities'))
...
# ### company size  filter##
#     def q_size_sex_barchart_industrychart(position, size, cheight):
#         most_recent_date = datetime.now().year
#         gender_codes = ['M', 'F', 'O']
#         data = cached_queryset1.filter(Q(gender_code__in=gender_codes) & Q(position_category=position) & Q(company_size=size) & Q(year_created=most_recent_date)).values('gender_code').annotate(count=Count('gender_code'))
...
#     def q_size_minority_barchart_industrychart(position, size, cheight):
#         most_recent_date = datetime.now().year
#         visible_minorities = ['Y', 'N']
#         data = cached_queryset1.filter(Q(visible_minorities__in=visible_minorities) & Q(position_category=position) & Q(company_size=size) & Q(year_created=most_recent_date)).values('visible_minorities').annotate(count=Count('visible_minorities'))
...
#     def q_size_aboriginal_barchart_industrychart(position, size, cheight):
#         most_recent_date = datetime.now().year
#         aboriginal_peoples = ['Y', 'N']
#         data = cached_queryset1.filter(Q(visible_minorities__in=aboriginal_peoples) & Q(position_category=position) & Q(company_size=size) & Q(year_created=most_recent_date)).values('aboriginal_peoples').annotate(count=Count('aboriginal_peoples'))
...
#     def q_size_disability_barchart_industrychart(position, size, cheight):
#         most_recent_date = datetime.now().year
#         person_with_disabilities = ['Y', 'N']
#         data = cached_queryset1.filter(Q(visible_minorities__in=person_with_disabilities) & Q(position_category=position) & Q(company_size=size) & Q(year_created=most_recent_date)).values('person_with_disabilities').annotate(count=Count('person_with_disabilities'))
...
#     def q_size_create_donut_chart(field_name, size):
#         # Get the count of 'Y' and 'N' values for the field
#         most_recent_date = datetime.now().year
#         data = cached_queryset1.filter(company_size=size, year_created=most_recent_date).values(field_name).annotate(count=Count(field_name))
#         yes_count = next((item for item in data if item[field_name] == 'Y'), {'count': 0})['count']
...
#     def q_size_sex_donut_industrychart(size):
#         most_recent_date = datetime.now().year
#         male = cached_queryset1.filter(gender_code='M', company_size=size, year_created=most_recent_date).count()
#         female = cached_queryset1.filter(gender_code='F', company_size=size, year_created=most_recent_date).count()
#         other = cached_queryset1.filter(gender_code='O', company_size=size, year_created=most_recent_date).count()
...
#     def q_create_donut_chart(category, category_field, labels, colors, hole_info_text):
#         """
#         Creates a donut chart for the given category
...
#     def q_minority_donut_industrychart():
#         labels = ['Yes','No']
#         colors = [colour2, colour3]
#         return q_create_donut_chart("Minority", "visible_minorities", labels, colors, "Yes")

#     def q_aboriginal_donut_industrychart():
#         labels = ['Yes','No']
#         colors = [colour2, colour3]
#         return q_create_donut_chart('Aboriginal', "aboriginal_peoples", labels, colors, "Yes")

#     def q_disability_donut_industrychart():
#         labels = ['Yes','No']
#         colors = [colour2, colour3]
#         return q_create_donut_chart("Disability", "person_with_disabilities", labels, colors, "Yes")



#     sex_dchart1, sexchart_hole_info =  q_sex_donut_industrychart()
#     minority_dchart1, minority_hole_info =  q_minority_donut_industrychart()
#     aboriginal_dchart1, aboriginal_hole_info =  q_aboriginal_donut_industrychart()
#     disability_dchart1, disability_hole_info =  q_disability_donut_industrychart()

#     Companydata_sex_dchart1, Companydata_sexchart_hole_info =  q_Companydata_sex_donut_industrychart()
#     Companydata_minority_dchart1, Companydata_minority_hole_info =  q_Companydata_create_donut_chart('visible_minorities')
#     Companydata_aboriginal_dchart1, Companydata_aboriginal_hole_info =  q_Companydata_create_donut_chart('aboriginal_peoples')
#     Companydata_disability_dchart1, Companydata_disability_hole_info =  q_Companydata_create_donut_chart('person_with_disabilities')

#     sex_executive_barchart = q_sex_barchart_industrychart('Executive', 24)
#     sex_senior_leader_barchart = q_sex_barchart_industrychart('Senior Leader', 24)
#     sex_manager_s_s_leader_barchart = q_sex_barchart_industrychart('Manager/Supervisor/Superintendent', 24)
#     sex_foreperson_leader_barchart = q_sex_barchart_industrychart('Foreperson', 24)
#     sex_individual_contributor_leader_barchart = q_sex_barchart_industrychart('Individual Contributor', 24)

#     minority_executive_barchart = q_minority_barchart_industrychart('Executive', 24)
#     minority_senior_leader_barchart = q_minority_barchart_industrychart('Senior Leader', 24)
#     minority_manager_s_s_leader_barchart = q_minority_barchart_industrychart('Manager/Supervisor/Superintendent', 24)
#     minority_foreperson_leader_barchart = q_minority_barchart_industrychart('Foreperson', 24)
#     minority_individual_contributor_leader_barchart = q_minority_barchart_industrychart('Individual Contributor', 24)

#     aboriginal_executive_barchart = q_aboriginal_barchart_industrychart('Executive', 24)
#     aboriginal_senior_leader_barchart = q_aboriginal_barchart_industrychart('Senior Leader', 24)
#     aboriginal_manager_s_s_leader_barchart = q_aboriginal_barchart_industrychart('Manager/Supervisor/Superintendent', 24)
#     aboriginal_foreperson_leader_barchart = q_aboriginal_barchart_industrychart('Foreperson', 24)
#     aboriginal_individual_contributor_leader_barchart = q_aboriginal_barchart_industrychart('Individual Contributor', 24)

#     disability_executive_barchart = q_disability_barchart_industrychart('Executive', 24)
#     disability_senior_leader_barchart = q_disability_barchart_industrychart('Senior Leader', 24)
#     disability_manager_s_s_leader_barchart = q_disability_barchart_industrychart('Manager/Supervisor/Superintendent', 24)
#     disability_foreperson_leader_barchart = q_disability_barchart_industrychart('Foreperson', 24)
#     disability_individual_contributor_leader_barchart = q_disability_barchart_industrychart('Individual Contributor', 24)

#     c_sex_executive_barchart = q_c_sex_barchart_industrychart('Executive', 24)
#     c_sex_senior_leader_barchart = q_c_sex_barchart_industrychart('Senior Leader', 24)
#     c_sex_manager_s_s_leader_barchart = q_c_sex_barchart_industrychart('Manager/Supervisor/Superintendent', 24)
#     c_sex_foreperson_leader_barchart = q_c_sex_barchart_industrychart('Foreperson', 24)
#     c_sex_individual_contributor_leader_barchart = q_c_sex_barchart_industrychart('Individual Contributor', 24)

#     c_minority_executive_barchart = q_c_minority_barchart_industrychart('Executive', 24)
#     c_minority_senior_leader_barchart = q_c_minority_barchart_industrychart('Senior Leader', 24)
#     c_minority_manager_s_s_leader_barchart = q_c_minority_barchart_industrychart('Manager/Supervisor/Superintendent', 24)
#     c_minority_foreperson_leader_barchart = q_c_minority_barchart_industrychart('Foreperson', 24)
#     c_minority_individual_contributor_leader_barchart = q_c_minority_barchart_industrychart('Individual Contributor', 24)

#     c_aboriginal_executive_barchart = q_c_aboriginal_barchart_industrychart('Executive', 24)
#     c_aboriginal_senior_leader_barchart = q_c_aboriginal_barchart_industrychart('Senior Leader', 24)
#     c_aboriginal_manager_s_s_leader_barchart = q_c_aboriginal_barchart_industrychart('Manager/Supervisor/Superintendent', 24)
#     c_aboriginal_foreperson_leader_barchart = q_c_aboriginal_barchart_industrychart('Foreperson', 24)
#     c_aboriginal_individual_contributor_leader_barchart = q_c_aboriginal_barchart_industrychart('Individual Contributor', 24)

#     c_disability_executive_barchart = q_c_disability_barchart_industrychart('Executive', 24)
#     c_disability_senior_leader_barchart = q_c_disability_barchart_industrychart('Senior Leader', 24)
#     c_disability_manager_s_s_leader_barchart = q_c_disability_barchart_industrychart('Manager/Supervisor/Superintendent', 24)
#     c_disability_foreperson_leader_barchart = q_c_disability_barchart_industrychart('Foreperson', 24)
#     c_disability_individual_contributor_leader_barchart = q_c_disability_barchart_industrychart('Individual Contributor', 24)
